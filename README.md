<<<<<<< HEAD
# SignComm
**SignComm** is an AI-powered sign language translator that helps deaf and mute individuals communicate effectively. It uses the **Gemini AI model** for text processing and **text-to-speech (TTS)** for voice output. Built with **React.js** and **Flask**, SignComm enhances accessibility by converting sign language into text and speech. 🚀
=======
